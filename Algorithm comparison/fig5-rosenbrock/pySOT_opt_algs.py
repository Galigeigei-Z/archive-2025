...
# ---------- 主函数 ----------
def NDCT_standard_PSO(f, x_dim, bounds, iter_tot=100, init_samples=20, K_list=None, lam=1e-6, has_x0=False):
    """
    ...
    gbest, gbest_val = pso_optimize_with_surrogate(
        surrogate, bounds, n_particles=10, iters=iter_tot
    )
...
def NDCT_modified_PSO(f, x_dim, bounds, iter_tot=20, init_samples=20, K_list=None, lam=1e-6, has_x0=False):
    """
